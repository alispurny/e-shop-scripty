...
`;
  ...
  function createHub(root) {
    ...
    root.innerHTML = '<div class="mbia__shell"><header class="mbia__hero"><h2 class="mbia__title">Najděte článek podle toho, co právě řešíte</h2><p class="mbia__lead">Prohledejte poradnu MyBears podle tématu, konkrétní otázky nebo cíle. Nové články se do přehledu načítají automaticky z blogu.</p><div class="mbia__hero-meta"><span class="mbia__hero-chip">Aktuální články z poradny</span><span class="mbia__hero-chip">Tematické série</span><span class="mbia__hero-chip">Bez registrace</span></div></header><div class="mbia__body" data-role="body"><div class="mbia__skeleton" aria-label="Načítání článků"></div></div></div>';
    ...
    function seriesHtml() {
      ...
      return '<section class="mbia__series" aria-labelledby="' + uid + '-series"><h3 class="mbia__section-title" id="' + uid + '-series">Projděte si celé tematické série</h3><p class="mbia__section-help">Začněte základním článkem a pokračujte do většího detailu.</p><div class="mbia__series-grid">' + series.map(function (item) {
