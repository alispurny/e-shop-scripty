            ...
            <section id="mybears-smart-tools" aria-labelledby="mybears-smart-tools-title">
                ...
                <div class="mb-tools-grid">
                    <article class="mb-tool-card">
                        ...
                        <p>Srovnejte složení, množství účinných látek a další vlastnosti produktů přehledně vedle sebe.</p>
                    ...
                    <article class="mb-tool-card">
                        ...
                        <p>Zjistěte, které vitamíny, minerály a další účinné látky se ve vybraných produktech překrývají.</p>
                    ...
                    <article class="mb-tool-card">
                        ...
                        <p>Vyberte si více produktů MyBears na jednom místě a vytvořte si vlastní kombinaci podle svých potřeb.</p>
