...
`;
  ...
  function createHub(root) {
    ...
    root.innerHTML = '<div class="mbia__shell"><header class="mbia__hero"><h2 class="mbia__title">Nájdite článok podľa toho, čo práve riešite</h2><div class="mbia__hero-meta"><span class="mbia__hero-chip">Aktuálne články z poradne</span><span class="mbia__hero-chip">Tematické série</span><span class="mbia__hero-chip">Bez registrácie</span></div></header><div class="mbia__body" data-role="body"><div class="mbia__skeleton" aria-label="Načítanie článkov"></div></div></div>';
