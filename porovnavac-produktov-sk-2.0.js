...
/* Comparator layout and table readability corrections 3.1 */
.mbpc__grid{align-items:stretch!important}
.mbpc__card{height:100%!important}
.mbpc__card-top{flex:1 1 auto!important}
.mbpc__card-copy{display:flex!important;flex-direction:column!important;min-width:0!important;height:100%!important}
.mbpc__card-summary{flex:0 0 auto!important}
.mbpc__tags{margin-top:auto!important}
.mbpc__card-actions{margin-top:auto!important;padding-top:14px!important;align-self:stretch!important}
.mbpc__select-product{min-height:46px!important}
.mbpc__table{table-layout:fixed!important}
.mbpc__table .mbpc__row-label,.mbpc__table .mbpc__product-head{width:auto!important;min-width:0!important;max-width:none!important}
.mbpc__table thead .mbpc__row-label{vertical-align:middle!important;text-align:center!important;padding:18px 14px!important}
.mbpc__parameter-head{display:flex!important;min-height:230px!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:8px!important;text-align:center!important}
.mbpc__parameter-head strong{display:block!important;color:#fff!important;-webkit-text-fill-color:#fff!important;font-size:18px!important;line-height:1.25!important}
.mbpc__parameter-head span{display:block!important;max-width:180px!important;color:#fff!important;-webkit-text-fill-color:#fff!important;font-size:12px!important;font-weight:400!important;line-height:1.45!important;opacity:.88!important}
.mbpc__table thead .mbpc__product-head{vertical-align:top!important;padding:14px!important}
.mbpc__table thead .mbpc__product-head-inner{height:100%!important;min-height:230px!important;justify-content:flex-start!important}
.mbpc__table thead .mbpc__product-name,.mbpc__table thead .mbpc__product-price,.mbpc__table thead .mbpc__availability{color:#fff!important;-webkit-text-fill-color:#fff!important}
.mbpc__table thead .mbpc__head-actions{margin-top:auto!important}
.mbpc__table thead .mbpc__head-actions .mbpc__button,.mbpc__table thead .mbpc__head-actions a.mbpc__button{background:#fff!important;border-color:#e5e3dc!important;color:#000!important;-webkit-text-fill-color:#000!important}
.mbpc__table thead .mbpc__head-actions .mbpc__button--primary,.mbpc__table thead .mbpc__head-actions a.mbpc__button--primary{background:var(--green)!important;border-color:var(--green)!important;color:#000!important;-webkit-text-fill-color:#000!important}
.mbpc__table tbody .mbpc__row-label{color:#000!important;-webkit-text-fill-color:#000!important;vertical-align:middle!important}
.mbpc__table td{vertical-align:middle!important;overflow-wrap:anywhere!important}
@media(max-width:760px){.mbpc__parameter-head,.mbpc__table thead .mbpc__product-head-inner{min-height:205px!important}.mbpc__table thead .mbpc__product-head{padding:10px!important}}
...
`;
  ...
  function emit(eventName, detail) {
    ...
    window.dataLayer.push(Object.assign({event:eventName,component:'mybears_product_comparison'},detail||{}));
  }
  ...
  function createApp(root) {
    ...
    function equalColumnGroup(products) {
      const count=products.length+1;
      const width=(100/count).toFixed(5)+'%';
      return '<colgroup>'+Array.from({length:count},function(){return '<col style="width:'+width+'">';}).join('')+'</colgroup>';
    }

    function comparisonTableMinWidth(products) {
      return Math.max(780,(products.length+1)*230);
    }
