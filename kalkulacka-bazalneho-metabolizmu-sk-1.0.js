...
(function () {
  ...
  var T = {"locale":"sk-SK","lang":"sk","version":"3.0.0-sk","style_id":"mb-bmr-calculator-styles-sk-v3","region_label":"Interaktívna kalkulačka bazálneho metabolizmu","title":"Kalkulačka bazálneho metabolizmu (BMR)","lead":"Vypočítajte si orientačný pokojový energetický výdaj podľa veku, výšky, hmotnosti a variantu rovnice pre ženy alebo mužov.","notice":"<strong>Dôležité:</strong> Výsledok je orientačný odhad podľa rovnice Mifflin–St Jeor. Nejde o presné laboratórne meranie ani o odporúčaný minimálny príjem energie. Kalkulačka je určená pre dospelých od 18 rokov.","panel_title":"Zadajte svoje údaje","sex":"Variant rovnice","female":"Žena","male":"Muž","sex_hint":"Rovnica používa dva varianty podľa pohlavia, pre ktoré bola pôvodne odvodená.","age":"Vek","age_unit":"rokov","age_placeholder":"napr. 35","age_hint":"Povolené rozpätie: 18–100 rokov","height":"Výška","height_unit":"cm","height_placeholder":"napr. 172","height_hint":"Povolené rozpätie: 100–250 cm","weight":"Hmotnosť","weight_unit":"kg","weight_placeholder":"napr. 74","weight_hint":"Povolené rozpätie: 20–400 kg","activity":"Úroveň aktivity – voliteľné","activity_none":"Zobraziť iba pokojový výdaj","activity_low":"Nízka aktivita (PAL 1,4)","activity_medium":"Stredná aktivita (PAL 1,6)","activity_high":"Vysoká aktivita (PAL 1,8)","activity_very_high":"Veľmi vysoká aktivita (PAL 2,0)","activity_hint":"Po výbere sa zobrazí aj hrubý odhad celkového denného energetického výdaja. Úroveň aktivity býva náročné presne odhadnúť.","calculate":"Vypočítať BMR","reset":"Vymazať údaje","result_label":"Orientačný pokojový energetický výdaj","kcal_day":"kcal / deň","method":"Mifflin–St Jeor","kj_label":"Prepočet na kilojouly","hour_label":"Priemer za jednu hodinu","inputs_label":"Zadané údaje","tdee_label":"Orientačný celkový denný energetický výdaj podľa zvoleného PAL","result_note":"<strong>Výsledok nie je automatický kalorický cieľ.</strong> Skutočný výdaj sa môže líšiť podľa telesného zloženia, zdravotného stavu, teploty, spánku, pohybu a ďalších faktorov. Na presnejšie meranie pokojového výdaja sa používa nepriama kalorimetria.","privacy":"Výpočet prebieha iba vo vašom prehliadači. Zadaný vek, výška, hmotnosť ani zvolený variant rovnice sa týmto skriptom nikam neodosielajú ani neukladajú.","errors":{"sex":"Vyberte variant rovnice pre ženu alebo muža.","age":"Zadajte vek v rozpätí 18 až 100 rokov.","height":"Zadajte výšku v rozpätí 100 až 250 cm.","weight":"Zadajte hmotnosť v rozpätí 20 až 400 kg.","activity":"Vyberte platnú úroveň aktivity."},"sex_label":{"female":"žena","male":"muž"},"summary":"Podľa zadaných údajov vychádza orientačný pokojový energetický výdaj približne {{value}} kcal za 24 hodín. Ide o odhad energie spotrebovanej v pokojových podmienkach, nie o presné laboratórne meranie.","formula":"Výpočet: 10 × {{weight}} kg + 6,25 × {{height}} cm − 5 × {{age}} rokov {{constant}} = približne {{result}} kcal / deň.","tdee_note":"{{activity}}. Výpočet je BMR/REE × PAL a slúži iba ako hrubý orientačný odhad udržiavacieho energetického výdaja.","day":"deň","hour":"hod"};
