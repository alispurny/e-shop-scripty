/**
 * MyBears — převodník jednotek krevních lipidů
 * Sjednocený vizuální systém podle MyBears interaktivní poradny.
 * Funkční logika, převodní faktory, interní ID a způsob vložení zůstávají zachované.
 *
 * Mount point:
...
(function () {
  ...
  var T = {"locale":"cs-CZ","root":"mb-lipid-converter","style":"mb-lipid-converter-styles","version":"3.0.0-cz","title":"Převodník cholesterolu a lipidových hodnot","lead":"Převádějte celkový cholesterol, LDL, HDL, non-HDL a triglyceridy mezi mmol/l a mg/dl. Z lipidogramu můžete dopočítat také non-HDL cholesterol a doplňkové poměry.","notice":"<strong>Důležité:</strong> Převody a dopočty jsou matematické. Kalkulačka nestanovuje diagnózu ani léčebný cíl; cílové hodnoty se určují podle celkového kardiovaskulárního rizika a zdravotního stavu.","tabs_label":"Režim převodníku","tab_single":"Převod jedné hodnoty","tab_panel":"Výpočet z lipidogramu","single_title":"Převod mmol/l a mg/dl","analyte":"Ukazatel","value":"Hodnota","input_unit":"Zadaná jednotka","analytes":{"tc":"Celkový cholesterol","ldl":"LDL cholesterol","hdl":"HDL cholesterol","nonhdl":"Non-HDL cholesterol","remnant":"Remnant cholesterol","tg":"Triglyceridy"},"hint_chol":"Pro cholesterolové ukazatele se používá faktor 38,67.","hint_tg":"Pro triglyceridy se používá odlišný faktor 88,57.","calculate_single":"Převést hodnotu","reset":"Vymazat údaje","single_result":"Převedená hodnota","factor_label":"Použitý převod","panel_title":"Dopočet z lipidového profilu","panel_intro":"Zadejte hodnoty ze stejného laboratorního výsledku a ve stejné jednotce. LDL je volitelné, ale je potřeba pro poměr LDL/HDL a odhad remnant cholesterolu.","panel_unit":"Jednotka lipidogramu","tc":"Celkový cholesterol","hdl":"HDL cholesterol","ldl":"LDL cholesterol (volitelně)","tg":"Triglyceridy","panel_hint":"Zadejte laboratorní hodnoty bez textu jednotky. Desetinnou čárku i tečku kalkulačka rozpozná.","calculate_panel":"Vyhodnotit lipidogram","derived_title":"Dopočtené ukazatele","nonhdl":"Non-HDL cholesterol","tc_hdl":"Poměr celkový cholesterol / HDL","ldl_hdl":"Poměr LDL / HDL","tg_hdl":"Poměr triglyceridy / HDL","remnant":"Odhad remnant cholesterolu","converted_title":"Převod zadaných hodnot","indicator":"Ukazatel","mmol":"mmol/l","mg":"mg/dl","ratio_note":"Poměr triglyceridů k HDL je vypočten z hodnot v mg/dl, protože tento způsob se často používá v odborné literatuře. Poměry nejsou samostatné diagnostické testy ani univerzální léčebné cíle.","remnant_note":"Remnant cholesterol je zde pouze aritmetický odhad: celkový cholesterol − LDL − HDL. Pokud byl LDL v laboratoři pouze vypočten, nejde o zcela nezávislý údaj.","inconsistent":"Zadané hodnoty vedou k zápornému odhadu remnant cholesterolu. Zkontrolujte jednotky a opis laboratorního výsledku; remnant cholesterol proto nebyl zobrazen.","privacy":"Výpočet probíhá pouze ve vašem prohlížeči. Zadané laboratorní hodnoty se tímto skriptem nikam neodesílají ani neukládají.","na":"Nelze vypočítat","errors":{"number":"Zadejte platnou číselnou hodnotu.","single_chol_mmol":"Zadejte hodnotu v rozmezí 0,1–30,0 mmol/l.","single_chol_mg":"Zadejte hodnotu v rozmezí 4–1160 mg/dl.","single_tg_mmol":"Zadejte triglyceridy v rozmezí 0,1–50,0 mmol/l.","single_tg_mg":"Zadejte triglyceridy v rozmezí 9–4430 mg/dl.","panel_required":"Vyplňte celkový cholesterol, HDL a triglyceridy.","panel_range":"Některá zadaná hodnota je mimo povolené rozmezí.","panel_relation":"Celkový cholesterol musí být vyšší než HDL cholesterol."},"formula_chol_mmol":"{{value}} mmol/l × 38,67 = {{result}} mg/dl.","formula_chol_mg":"{{value}} mg/dl ÷ 38,67 = {{result}} mmol/l.","formula_tg_mmol":"{{value}} mmol/l × 88,57 = {{result}} mg/dl.","formula_tg_mg":"{{value}} mg/dl ÷ 88,57 = {{result}} mmol/l.","region_label":"Interaktivní převodník cholesterolu a krevních lipidů","table_caption":"Převod laboratorních hodnot krevních lipidů mezi mmol/l a mg/dl"};
  var ROOT_ID = T.root;
...
/* Uživatelská úprava: veškerý text převodníku je černý. */
#${ROOT_ID},
#${ROOT_ID} *,
#${ROOT_ID} *::before,
#${ROOT_ID} *::after {
