/**
 * MyBears — kalkulačka poměru pasu k výšce
...
(function () {
  ...
  var T = {"locale":"cs-CZ","root":"mb-waist-height-calculator","style":"mb-waist-height-calculator-styles","version":"3.0.0-cz","title":"Kalkulačka poměru pasu k výšce","lead":"Zjistěte, jakou část vaší výšky tvoří obvod pasu a do jakého orientačního pásma výsledek spadá.","notice":"<strong>Důležité:</strong> Kalkulačka je určená pro dospělé. Výsledek je screeningový údaj, nikoliv diagnóza. V těhotenství ani při výrazném zvětšení břicha z jiné příčiny nemusí být použitelný.","height":"Výška","waist":"Obvod pasu","height_hint":"Měřte bez obuvi, ve vzpřímeném postoji.","waist_hint":"Měřte po běžném výdechu, vodorovně v polovině mezi posledním hmatným žebrem a horním okrajem kyčelní kosti.","calculate":"Vypočítat poměr","reset":"Vymazat údaje","result_label":"Váš poměr pasu k výšce","badge_low":"Nízký poměr","badge_healthy":"Bez zvýšené centrální adipozity","badge_increased":"Zvýšená centrální adipozita","badge_high":"Vysoká centrální adipozita","summary_low":"Výsledek je pod hlavním klasifikačním rozmezím NICE. Samotný nízký poměr neurčuje podváhu ani zdravotní stav; posuzujte jej společně s BMI, vývojem hmotnosti a dalšími údaji.","summary_healthy":"Výsledek spadá do pásma 0,40–0,49, které NICE označuje jako zdravou centrální adipozitu bez zvýšeného zdravotního rizika podle tohoto ukazatele.","summary_increased":"Výsledek spadá do pásma 0,50–0,59. NICE jej označuje jako zvýšenou centrální adipozitu a zvýšené zdravotní riziko.","summary_high":"Výsledek je 0,60 nebo vyšší. NICE jej označuje jako vysokou centrální adipozitu a dále zvýšené zdravotní riziko.","scale_title":"Orientační klasifikace poměru pasu k výšce","scale_low":"Pod 0,40","scale_healthy":"0,40–0,49","scale_increased":"0,50–0,59","scale_high":"0,60 a více","waist_percent":"Pas tvoří z výšky","half_height":"Polovina vaší výšky","difference":"Rozdíl vůči polovině výšky","formula":"Výpočet","privacy":"Výpočet probíhá pouze ve vašem prohlížeči. Zadaná výška ani obvod pasu se tímto skriptem nikam neodesílají ani neukládají.","below":"pod hranicí","above":"nad hranicí","equal":"přesně na hranici","cm":"cm","percent":"%","errors":{"height":"Zadejte výšku v rozmezí 100–250 cm.","waist":"Zadejte obvod pasu v rozmezí 30–200 cm.","generic":"Výpočet se nepodařilo dokončit. Zkontrolujte zadané údaje."},"warning":"Poměr pasu k výšce doplňuje BMI, krevní tlak, glykémii a krevní tuky. Pokud máte BMI 35 a více, rychle se měnící obvod břicha nebo zdravotní potíže, nespoléhejte pouze na tento výpočet.","region_label":"Interaktivní kalkulačka poměru pasu k výšce"};
  var ROOT_ID = T.root;
