...
`;
  ...
  var T = {"locale":"sk-SK","version":"2.0.0-sk","root":"mb-protein-intake-calculator","style":"mb-protein-intake-calculator-styles","title":"Kalkulačka denného príjmu bielkovín","lead":"Odhadnite orientačné denné rozpätie bielkovín podľa hmotnosti, veku, pohybovej aktivity a cieľa.","notice":"<strong>Dôležité:</strong> Výsledok je pracovné rozpätie pre zdravých dospelých. Nie je určený pre deti, tehotné ženy, osoby s ochorením obličiek ani pre klinickú výživu.","weight":"Telesná hmotnosť","weight_hint":"Výpočet používa aktuálnu hmotnosť. Pri výrazne vyššom podiele telesného tuku môže byť vhodná individuálna výpočtová hmotnosť stanovená odborníkom.","height":"Výška (voliteľná)","height_hint":"Slúži iba na orientačné upozornenie pri vyššom BMI; samotný výpočet nemení.","age":"Vek","activity":"Pohybová aktivita","goal":"Hlavný cieľ","meals":"Počet hlavných jedál za deň","activity_options":[["low","Nízka – bez pravidelného športu"],["endurance","Vytrvalostný šport"],["mixed","Kombinovaný šport a pravidelný pohyb"],["strength","Silový tréning"]],"goal_options":[["maintain","Bežný príjem a udržanie"],["muscle","Budovanie alebo udržanie svalov"],["reduction","Redukcia hmotnosti so zachovaním svalov"]],"calculate":"Vypočítať príjem","reset":"Vymazať údaje","result_label":"Orientačný denný príjem bielkovín","badge":"Pracovné rozpätie","summary_prefix":"Pre zvolený profil kalkulačka používa rozpätie","scale_title":"Použité rozpätie v gramoch na kilogram hmotnosti","midpoint":"Stred rozpätia","per_meal":"Pri rovnomernom rozdelení na jedno jedlo","energy":"Energia zo stredu rozpätia","profile":"Použitý profil","formula":"Výpočet","privacy":"Výpočet prebieha iba vo vašom prehliadači. Zadané údaje sa týmto skriptom nikam neodosielajú ani neukladajú.","errors":{"weight":"Zadajte telesnú hmotnosť v rozmedzí 30–250 kg.","height":"Výšku nechajte prázdnu alebo zadajte hodnotu 120–230 cm.","age":"Zadajte vek v rozmedzí 18–100 rokov.","generic":"Výpočet sa nepodarilo dokončiť. Skontrolujte zadané údaje."},"profiles":{"general":"bežný režim","older":"vek 65+","endurance":"vytrvalostný šport","mixed":"kombinovaný šport","strength":"silový tréning","muscle":"cieľ budovania svalov","reduction":"redukčný režim"},"warnings":{"base":"Ide o orientačné rozpätie, nie povinný cieľ. Dôležitá je aj kvalita jedálnička, celkový energetický príjem a dlhodobý vývoj.","older":" Vo vyššom veku je vhodné posudzovať príjem spolu so zdravotným stavom, chuťou do jedla a pohybom, najmä silovým tréningom.","muscle_low":" Samotné zvýšenie príjmu bielkovín bez zodpovedajúceho silového podnetu nezaručuje rast svalovej hmoty.","reduction":" Pri redukcii pomáha chrániť svalovú hmotu aj primeraný energetický deficit a silový tréning.","bmi":" Pri BMI 30 a viac môže výpočet z aktuálnej hmotnosti príjem nadhodnotiť; individuálnu výpočtovú hmotnosť stanovuje odborník.","medical":" Pri ochorení obličiek, nariadenom obmedzení bielkovín, poruche príjmu potravy, v tehotenstve alebo pri závažnom ochorení postupujte podľa odporúčania zdravotníka."}};
  var ROOT_ID = T.root;
