...
/**
 * MyBears — kalkulačka denného príjmu kofeínu
 * Zjednotený vizuálny systém podľa interaktívnej poradne MyBears.
 * Funkčná logika, výpočty, interné ID a spôsob vloženia zostávajú zachované.
 *
 * Miesto vloženia:
...
(function () {
  ...
  var T = {"locale":"sk-SK","version":"3.0.0-sk","root":"mb-caffeine-intake-calculator","style":"mb-caffeine-intake-calculator-styles","title":"Kalkulačka denného príjmu kofeínu","lead":"Spočítajte kofeín z kávy, čaju, energetických nápojov, koly, čokolády a vlastných produktov. Výsledok ukáže denný súčet, množstvo na kilogram hmotnosti a voliteľný odhad kofeínu zostávajúceho pred spaním.","notice":"<strong>Dôležité:</strong> Kalkulačka je určená dospelým od 18 rokov. Hodnoty v predvoľbách sú orientačné a konkrétny výrobok alebo spôsob prípravy môže obsahovať iné množstvo kofeínu.","profile":"Referenčný profil","profile_adult":"Zdravý dospelý","profile_preg":"Tehotenstvo alebo dojčenie","weight":"Telesná hmotnosť (voliteľné)","weight_hint":"Slúži iba na prepočet príjmu na mg/kg. Neurčuje individuálnu toleranciu kofeínu.","bedtime":"Plánovaný čas spánku (voliteľné)","bedtime_hint":"Ak pri položkách zadáte čas, kalkulačka modelovo odhadne množstvo kofeínu zostávajúce pred spaním.","sources_title":"Zdroje kofeínu počas dňa","sources_intro":"Pri každej položke môžete upraviť počet porcií aj množstvo kofeínu podľa etikety alebo údajov výrobcu.","source":"Zdroj","servings":"Počet porcií","mg_serving":"Kofeín v 1 porcii","time":"Čas príjmu","custom_name":"Názov vlastného zdroja","add":"Pridať ďalší zdroj","remove":"Odobrať","calculate":"Vypočítať príjem","reset":"Vymazať údaje","result":"Váš orientačný denný príjem kofeínu","daily_total":"Celkom za deň","reference":"Porovnávacia hodnota profilu","percent":"Podiel porovnávacej hodnoty","per_kg":"Príjem podľa hmotnosti","max_item":"Najvyššia zadaná položka","items_count":"Počet zadaných zdrojov","scale":"Orientačné porovnanie denného súčtu","sleep_title":"Modelový odhad kofeínu pred spaním","sleep_average":"Odhad pri priemernom polčase 4 hodiny","sleep_range":"Možné rozpätie pri polčase 2–8 hodín","sleep_missing":"Na výpočet pred spaním zadajte čas spánku a čas aspoň pri jednej položke.","single_title":"Najvyšší príjem v jednej položke","details":"Rozpis započítaných zdrojov","item":"Položka","subtotal":"Kofeín celkom","privacy":"Výpočet prebieha iba vo vašom prehliadači. Zadané údaje sa týmto skriptom nikam neodosielajú ani neukladajú.","preset_note":"Prednastavené hodnoty vychádzajú z orientačných porcií EFSA. Obsah kofeínu sa môže výrazne líšiť podľa značky, veľkosti porcie a prípravy.","per_day":"mg/deň","region_label":"Interaktívna kalkulačka denného príjmu kofeínu","result_table_caption":"Rozpis zdrojov kofeínu zahrnutých do výpočtu","profiles":{"adult":{"label":"zdravý dospelý","daily":400,"daily_note":"EFSA uvádza, že príjem do 400 mg za deň rozložený počas dňa u zdravých dospelých vo všeobecnosti nevyvoláva bezpečnostné obavy. Nejde o odporúčaný cieľ ani o hranicu vhodnú pre každého."},"preg":{"label":"tehotenstvo alebo dojčenie","daily":200,"daily_note":"EFSA uvádza pre tehotné a dojčiace ženy príjem zo všetkých zdrojov do 200 mg za deň. Individuálny postup je vhodné konzultovať so zdravotníkom."}},"presets":[["filter","Filtrovaná káva (200 ml)",90],["espresso","Espresso (60 ml)",80],["black_tea","Čierny čaj (220 ml)",50],["cola","Kola (355 ml)",40],["energy","Energetický nápoj (250 ml)",80],["dark_choc","Horká čokoláda (50 g)",25],["milk_choc","Mliečna čokoláda (50 g)",10],["custom","Vlastný produkt alebo doplnok",100]],"messages":{"within":"Denný súčet neprekračuje porovnávaciu hodnotu zvoleného profilu. To však neznamená, že je toto množstvo vhodné práve pre vás; citlivosť sa výrazne líši.","over":"Denný súčet prekračuje porovnávaciu hodnotu zvoleného profilu. Skontrolujte najmä veľkosť porcií, etikety energetických nápojov a výživových doplnkov.","single_ok":"Najvyššia zadaná položka nepresahuje 200 mg. EFSA túto hodnotu uvádza pre jednorazový príjem u zdravých dospelých, nie ako odporúčanú dávku.","single_high":"Aspoň jedna zadaná položka obsahuje viac ako 200 mg kofeínu. Pri tehotenstve, dojčení, zdravotných ťažkostiach alebo užívaní liekov sa týmto porovnaním neriaďte bez konzultácie.","sleep":"Aj nižšie množstvo kofeínu môže u citlivého človeka ovplyvniť spánok. EFSA uvádza, že už 100 mg prijatých blízko času spánku môže u niektorých dospelých zmeniť dĺžku alebo priebeh spánku.","symptoms":"Pri búšení srdca, trasení, úzkosti, nespavosti, nevoľnosti alebo iných ťažkostiach ďalší kofeín nepridávajte a podľa závažnosti sa poraďte so zdravotníkom.","preg_single":"V tehotenstve ani pri dojčení nemožno jednorazovú hranicu 200 mg automaticky považovať za vhodnú dávku. Kalkulačka preto hodnotí predovšetkým celkový denný súčet."},"errors":{"weight":"Hmotnosť nechajte prázdnu alebo zadajte hodnotu 30–250 kg.","rows":"Pridajte aspoň jeden zdroj kofeínu s platným počtom porcií a množstvom v mg.","servings":"Počet porcií musí byť v rozmedzí 0,1–20.","mg":"Množstvo kofeínu v porcii musí byť v rozmedzí 0–1000 mg.","max_rows":"Možno pridať najviac 12 zdrojov.","generic":"Výpočet sa nepodarilo dokončiť. Skontrolujte zadané údaje."}};
  var ROOT_ID = T.root;
