/**
 * MyBears Product Guide 2.0.2 — produkčná samostatná verzia SK
 * Version: 2.0.2-sk
 * Product data verified: 2026-07-31
 * Guide UX/scoring updated: 2026-09-14
 *
 ...
 *   analytics: false,
 *   maxResults: 3,
 *   availabilityCandidatePool: 6,
 *   preferInStock: true,
 *   liveHydrationTimeoutMs: 3500,
 *   enableLiveHydration: true,
 *   enableAddToCart: true,
 *   minimumGoalScore: 30,
 *   enableComparison: true,
 *   labAnalysesUrl: '/laboratorne-analyzy',
...
(function () {
  ...
  const CATALOG = [
  {
    ...
    "url": "/p/gumove-medvediky-kvalitni-spanok",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "warnings": [
      ...
      "Pri užívaní sedatív alebo počas liečby sa poraďte s lekárom alebo lekárnikom."
    ],
    "facts": [
      "bez melatonínu",
      "večerné užívanie"
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-krasna-a-zdrava-plet-30",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "supply": "30–60 dní",
    "summary": "Antioxidačne zamerané gummies na starostlivosť o pleť po tridsiatke.",
    "keyIngredients": [
  ...
  {
    "id": "hsn-gummies",
    "name": "Gumené medvedíky Zdravé vlasy, koža a nechty",
    "url": "/p/gumove-medvediky-zdrave-vlasy-koza-a-nechty",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-omega-3-multivitamin-pre-deti",
    "kind": "single",
    "audiences": [
      "child"
    ],
    ...
    "supply": "15–30 dní",
    "summary": "Detské multivitamínové gummies s rastlinnými omega-3 z ľanového oleja.",
    "keyIngredients": [
    ...
    "warnings": [
      ...
      "Rastlinné omega-3 nie sú zdrojom EPA a DHA ako rybí olej."
    ],
    "facts": [
      "pre deti od 3 rokov",
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-aktivny-mozog",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-nakopavac-preworkout",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-na-chudnutie-travenie-detox",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "keyIngredients": [
      "500 mg prášku z jablčného octa",
      "vitamín C",
      "chróm"
    ],
    "warnings": [
      "Sprievodca nepripisuje produktu účinok na chudnutie; odporúčanie vychádza iba zo zloženia a zvolenej oblasti."
    ],
    "facts": [
      "1 medvedík denne"
    ]
  },
  {
    ...
    "url": "/p/gumove-medvediky-pohodicka-relax",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-dobra-naladicka",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-zdrava-crevna-mikroflora",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-silna-imunita",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/gumove-medvediky-multivitamin",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  {
    "id": "biotin-gummies",
    "name": "Gumené medvedíky s biotínom",
    "url": "/p/gumove-medvediky-s-biotinom",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "name": "Horčík chelát 100 mg (bisglycinát) + B6 1,4 mg P5P",
    "url": "/p/horcik-chelat-bisglycinat-vitamin-b6-p5p-doplnok-stravy",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vitamin-c-zelezo-b12-b9-kyselina-listova-doplnok-stravy",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "supply": "60 dní",
    "summary": "Komplex železa, vitamínu C, B12 a folátu v jednej kapsule.",
    "keyIngredients": [
  ...
  },
  {
    ...
    "url": "/p/zinok-chelat-15-mg-bisglycinat-doplnok-stravy",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "warnings": [
      "Dlhodobé užívanie vysokej dávky zinku konzultujte s odborníkom, najmä s ohľadom na rovnováhu medi."
    ],
    "facts": [
      "1 kapsula denne",
      "chelátová forma"
  ...
  },
  {
    ...
    "url": "/p/vitamin-d3-2000-iu-doplnok-stravy",
    "kind": "single",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/omega-3-mastne-kyseliny-300-mg-epa-220-mg-dha-doplnok-stravy",
    "kind": "single",
    "audiences": [
      "adult"
    ],
    ...
    "caffeine": false,
    "flavor": "bez príchute",
    "package": "60 softgelových kapsúl",
    "dose": "1–2 kapsuly denne s jedlom",
    "supply": "30–60 dní",
    "summary": "Koncentrovaný rybí olej s EPA a DHA v softgelovej kapsule.",
    "keyIngredients": [
      "omega-3 celkom 550 mg",
      "EPA 330 mg",
      "DHA 220 mg"
    ],
    "warnings": [
  ...
  },
  {
    ...
    "keyIngredients": [
      ...
      "keratín",
      "MSM",
      "kyselina hyalurónová 200 mg (50–100 kDa)",
      "koenzým Q10",
  ...
  },
  {
    ...
    "name": "Výhodný balíček Zdravé vlasy, koža a nechty – gumené medvedíky",
    "url": "/p/vyhodny-balicek-zdrave-vlasy-koza-a-nechty-gumove-medvedici",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
    ...
    "keyIngredients": [
      "Gummies Zdravé vlasy, koža a nechty",
      "Gummies Biotín 5 mg"
    ],
    "warnings": [
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-travenie-crevna-mikroflora-gumove-medvedici",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-kvalitni-spanok-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
    ...
    "dose": "podľa dávkovania jednotlivých produktov",
    "supply": "podľa jednotlivých balení",
    "summary": "Večerná kombinácia horčíka a gummies bez cukru a bez melatonínu.",
    "keyIngredients": [
      "Horčík bisglycinát + B6 P5P",
      "Gummies Kvalitný spánok bez cukru"
    ],
    "warnings": [
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-zdrave-vlasy-koza-a-nechty-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-dobra-naladicka-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-uspesne-ucenie-mentalny-vykon-pri-narocnom-povolani-2-0-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-krasa-veganske-kapsule-a-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "name": "Výhodný balíček Zelený reštart & energia",
    "url": "/p/vyhodny-balicek-detox-energia-veganske-kapsule",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-harmonia-veganske-kapsule",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-energia-veganske-kapsule",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-fyzicka-vykonnost-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-uspesne-ucenie-mentalny-vykon-pri-narocnom-povolani-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-silna-imunita-pre-celu-rodinu-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "family",
      "adult",
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-sport-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-imunita-veganske-kapsule",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
    ...
    "dose": "podľa dávkovania jednotlivých produktov",
    "supply": "podľa jednotlivých balení",
    "summary": "Komplexný kapsulový balíček pre každodennú rutinu a imunitnú oblasť.",
    "keyIngredients": [
      "Vitamín D3 + K2 MK-7",
      "Zinok chelát 25 mg",
      "Horčík bisglycinát + B6 P5P",
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-vitalita-veganske-kapsule",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
  ...
  },
  {
    ...
    "url": "/p/vyhodny-balicek-imunita-veganske-kapsule-gumove-medvediky",
    "kind": "bundle",
    "audiences": [
      "adult"
    ],
    ...
    "dose": "podľa dávkovania jednotlivých produktov",
    "supply": "podľa jednotlivých balení",
    "summary": "Rozšírený imunitný balíček kombinujúci kapsuly, softgely a gummies.",
    "keyIngredients": [
      "Horčík bisglycinát + B6 P5P",
      "Vitamín D3 + K2 MK-7",
      "Omega 3 EPA + DHA",
  ...
  const QUESTIONS = [
    {
      id: 'audience',
      title: 'Pre koho produkt vyberáte?',
      description: 'Najskôr zvoľte, komu má odporúčanie slúžiť.',
      options: [
        { value: 'adult', label: 'Pre dospelého', description: 'Doplnky a rutiny určené dospelým', icon: 'user' },
        { value: 'child', label: 'Pre dieťa od 3 rokov', description: 'Iba produkty výslovne určené deťom', icon: 'bear' },
        { value: 'family', label: 'Pre celú rodinu', description: 'Rodinné kombinácie s oddelenými produktmi', icon: 'family' }
      ]
    },
    {
      id: 'goal',
      title: 'Na čo sa chcete zamerať?',
      description: 'Vyberte hlavnú oblasť. Odporúčanie sa bude riadiť predovšetkým týmto cieľom.',
      options: [
        { value: 'sleep', label: 'Spánok a večerná rutina', description: 'Produkty vhodné pre večerný režim', icon: 'moon', audiences: ['adult'] },
        { value: 'calm', label: 'Pokoj a psychická pohoda', description: 'Produkty pre pokojnejšiu dennú alebo večernú rutinu', icon: 'leaf-heart', audiences: ['adult'] },
        { value: 'focus', label: 'Sústredenie a mentálny výkon', description: 'Produkty pre pracovnú alebo študijnú rutinu', icon: 'brain', audiences: ['adult'] },
        { value: 'energy', label: 'Energia a aktívny režim', description: 'Produkty vhodné pre aktívny každodenný režim', icon: 'bolt', audiences: ['adult'] },
        { value: 'immunity', label: 'Imunita', description: 'Vitamíny, minerály a rodinné varianty', icon: 'shield', audiences: ['adult', 'child', 'family'] },
        { value: 'beauty', label: 'Vlasy, pokožka a nechty', description: 'Beauty produkty, minerály a kolagén', icon: 'sparkles', audiences: ['adult'] },
        { value: 'mature_skin', label: 'Starostlivosť o pleť 30+', description: 'Kolagén a antioxidačne zamerané zloženie', icon: 'flower', audiences: ['adult'] },
        { value: 'digestion', label: 'Trávenie a mikroflóra', description: 'Probiotiká a súvisiace rutiny', icon: 'digestion', audiences: ['adult'] },
        { value: 'sport', label: 'Šport a fyzická výkonnosť', description: 'Horčík, pre-workout a športové rutiny', icon: 'dumbbell', audiences: ['adult'] },
        { value: 'joints', label: 'Kĺby a pohybový aparát', description: 'Komplexná kĺbová výživa a súvisiace produkty', icon: 'bone', audiences: ['adult'] },
        { value: 'daily', label: 'Každodenný základ', description: 'Univerzálne vitamíny, minerály a omega-3', icon: 'sun', audiences: ['adult'] },
        { value: 'child_daily', label: 'Vitamíny pre dieťa', description: 'Denné gummies pre deti od 3 rokov', icon: 'citrus', audiences: ['child'] }
      ]
    },
    {
      id: 'form',
      title: 'Aká forma vám vyhovuje?',
      description: 'Ak nemáte preferenciu, nechajte rozhodnúť predovšetkým zloženie a zameranie produktu.',
      options: [
        { value: 'any', label: 'Je mi to jedno', description: 'Rozhodne najmä zameranie a zloženie', icon: 'check-circle' },
        { value: 'gummies', label: 'Gumené medvedíky', description: 'Pohodlná ochutená forma', icon: 'bear' },
        { value: 'capsules', label: 'Kapsuly alebo softgely', description: 'Klasická forma bez príchute', icon: 'pill', audiences: ['adult'] },
        { value: 'powder', label: 'Rozpustný prášok', description: 'Kolagénové zmesi s odmerkou', icon: 'spoon', audiences: ['adult'] },
        { value: 'mixed', label: 'Kombinácia viacerých foriem', description: 'Vhodné, ak vám neprekáža viac produktov v rutine', icon: 'layers', audiences: ['adult', 'family'] }
      ]
    },
    {
      id: 'diet',
      title: 'Je pre vás niektorá vlastnosť produktu dôležitá?',
      description: 'Vyberte iba vtedy, ak je táto podmienka pre vás zásadná.',
      options: [
        { value: 'any', label: 'Bez osobitnej požiadavky', description: 'Neobmedzovať odporúčanie podľa týchto vlastností', icon: 'circle' },
        { value: 'vegan', label: 'Iba vegánske', description: 'Len produkty s potvrdeným vegánskym vyhotovením', icon: 'leaf' },
        { value: 'sugarFree', label: 'Iba bez cukru', description: 'Len produkty jednoznačne označené ako bez cukru', icon: 'sugar-off' },
        { value: 'glutenFree', label: 'Iba bez lepku', description: 'Len produkty s potvrdeným bezlepkovým vyhotovením', icon: 'wheat-off' },
        { value: 'halal', label: 'Iba halal', description: 'Len produkty s potvrdeným označením halal', icon: 'crescent-star' }
      ]
    },
    {
      id: 'stimulants',
      title: 'Chcete sa vyhnúť kofeínu?',
      description: 'Túto otázku zobrazujeme iba vtedy, keď môže skutočne ovplyvniť výber.',
      audiences: ['adult'],
      options: [
        { value: 'any', label: 'Nevadí mi', description: 'Môžu sa zobraziť aj produkty s kofeínom alebo zeleným čajom', icon: 'coffee' },
        { value: 'avoid', label: 'Chcem variant bez kofeínu', description: 'Produkty s kofeínom budú z odporúčania vyradené', icon: 'coffee-off' }
      ]
    }
  ];
...
.mbpg__eyebrow{display:inline-flex;align-items:center;gap:7px;margin:0 0 9px;font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--mbpg-green-dark)}
.mbpg__eyebrow::before{content:"";width:22px;height:3px;border-radius:999px;background:var(--mbpg-gold)}
.mbpg__quality-strip{display:flex;flex-wrap:wrap;gap:8px;margin:20px 0 0}
.mbpg__quality-strip span,.mbpg__trust-badges span{display:inline-flex;align-items:center;min-height:30px;padding:6px 10px;border:1px solid #dce8df;border-radius:999px;background:#f5faf6;color:#285d3c;font-size:12px;font-weight:750;line-height:1.2}
.mbpg__trust-badges{display:flex;flex-wrap:wrap;align-items:center;gap:7px;margin:10px 0 2px}
.mbpg__lab-link{font-size:12px;font-weight:750;color:var(--mbpg-green-dark);text-decoration:underline;text-underline-offset:3px}
.mbpg__why{margin:16px 0;padding:16px 18px;border:1px solid #dce8df;border-radius:14px;background:#f7fbf8}
.mbpg__why>strong{display:block;margin-bottom:8px;font-size:14px}
.mbpg__why ul{margin:0;padding-left:19px;display:grid;gap:5px;color:#424841;font-size:14px}
.mbpg__loading-state{text-align:center;padding-top:46px!important;padding-bottom:46px!important}
.mbpg__loading-icon{width:72px;height:72px;margin:0 auto 16px;display:flex}
.mbpg__loading-state .mbpg__lead{max-width:650px;margin-left:auto;margin-right:auto}
.mbpg__next-tools{display:flex;align-items:center;justify-content:space-between;gap:18px;margin:22px 0;padding:18px;border:1px solid var(--mbpg-line);border-radius:16px;background:var(--mbpg-cream)}
.mbpg__next-tools>div{display:grid;gap:4px}.mbpg__next-tools span{font-size:13px;color:var(--mbpg-muted)}
@media(max-width:700px){.mbpg__next-tools{align-items:stretch;flex-direction:column}.mbpg__next-tools .mbpg__button{width:100%;text-align:center}.mbpg__quality-strip{gap:6px}.mbpg__quality-strip span{font-size:11px}}
...
`;
  ...
  // MyBears Product Guide 2.0 metadata.
  // Lab status is informational only; it never makes a product medically more suitable.
  const LAB_TESTED_PRODUCT_IDS = new Set([
    'magnesium-bisglycinate',
    'magnesium-malate-potassium',
    'zinc-bisglycinate',
    'vitamin-d3-k2',
    'iron-c-b12-b9',
    'green-mix',
  ...
  // Products containing iron are not automatically recommended from a generic lifestyle goal.
  // They remain in the catalogue, but require deliberate product selection outside this guide.
  const GUIDE_RESTRICTED_PRODUCT_IDS = new Set([
    'iron-c-b12-b9',
    'bundle-beauty-iron'
  ]);

  function isLabTested(product) {
    return Boolean(product && LAB_TESTED_PRODUCT_IDS.has(product.id));
  }

  function isGuideEligible(product) {
    return Boolean(product && !GUIDE_RESTRICTED_PRODUCT_IDS.has(product.id));
  }

  function availabilityWeight(live) {
    if (!runtimeConfig.preferInStock) return 0;
    if (live?.availability === 'in') return 2;
    if (live?.availability === 'out') return 0;
    return 1;
  }

  function availabilityMarkup(live, loadingLabel = 'Overujeme cenu a dostupnosť…') {
    if (!live) return `<span>${escapeHtml(loadingLabel)}</span>`;
    const availabilityText = live.availability === 'in'
      ? 'Skladom'
      : live.availability === 'out'
        ? 'Momentálne nedostupné'
        : 'Dostupnosť na detaile';
    const availabilityClass = live.availability === 'in' ? ' is-in' : live.availability === 'out' ? ' is-out' : '';
    return `${live.price ? `<span>${escapeHtml(live.price)}</span>` : '<span>Cena na detaile produktu</span>'}<span class="mbpg__availability${availabilityClass}">${availabilityText}</span>`;
  }

  function productTrustBadges(product) {
    return unique([
      isLabTested(product) ? 'Laboratórne overené' : null,
      product.vegan === true ? 'Vegan' : null,
      product.glutenFree === true ? 'Bez lepku' : null,
      product.halal === true ? 'Halal' : null
    ]);
  }

  function productHighlights(product) {
    const ingredients = (product.keyIngredients || []).slice(0, 2);
    return unique([
      ...ingredients,
      ...(product.facts || []).slice(0, 1),
      isLabTested(product) ? 'laboratórne overené' : null
    ]).slice(0, 3);
  }
  ...
  function matchesProductFilters(product, answers, includeGoalThreshold = true) {
    if (!isGuideEligible(product)) return false;
  ...
  function scoreProduct(product, answers) {
    ...
    if (goalScore >= 80) reasons.push(`veľmi dobre zodpovedá oblasti „${GOAL_LABELS[answers.goal] || answers.goal}“`);
    else if (goalScore > 0) reasons.push(`zodpovedá oblasti „${GOAL_LABELS[answers.goal] || answers.goal}“`);

    if (answers.form && answers.form !== 'any' && productMatchesSelectedForm(product, answers.form)) {
      score += 22;
      if (answers.form === 'capsules') reasons.push('vyhovuje kapsulová alebo softgelová forma');
      else if (answers.form === 'mixed') reasons.push('vyhovuje kombinácia viacerých foriem');
      else reasons.push(`vyhovuje forma ${FORM_LABELS[answers.form] || answers.form}`);
    }

    // Without an explicit preference, a simple single product is easier to start with.
    if (product.kind === 'single') score += 5;
    else if (product.kind === 'bundle') score -= 2;

    if (answers.diet && answers.diet !== 'any' && product[answers.diet] === true) {
      score += 10;
      const dietLabels = {
        vegan: 'spĺňa vegánske vyhotovenie',
        sugarFree: 'je bez cukru',
        glutenFree: 'je bez lepku',
        halal: 'má potvrdené označenie halal'
      };
    ...
    if (answers.stimulants === 'avoid' && product.caffeine === false) {
      score += 4;
      reasons.push('neobsahuje kofeín');
    }

    // Trust information is shown to the user, but only gives a tiny tie-break boost.
    // It must never override suitability for the selected goal.
    if (isLabTested(product)) score += 1;

    const highlights = productHighlights(product);
    highlights.forEach((item) => {
      if (reasons.length < 3) reasons.push(item);
    });

    return { product, score, reasons: unique(reasons).slice(0, 3), live: null };
  }
  ...
  async function enrichRankingWithAvailability(entries, maxResults) {
    if (!runtimeConfig.enableLiveHydration || !entries.length) {
      return entries.slice(0, Math.max(1, Number(maxResults) || 3));
    }

    const enriched = await Promise.all(entries.map(async (entry) => {
      const live = await hydrateProduct(entry.product);
      return Object.assign({}, entry, { live });
    }));

    enriched.sort((a, b) => {
      const availabilityDifference = availabilityWeight(b.live) - availabilityWeight(a.live);
      if (availabilityDifference) return availabilityDifference;
      return b.score - a.score || b.product.priority - a.product.priority || a.product.name.localeCompare(b.product.name, 'sk');
    });

    const limit = Math.max(1, Number(maxResults) || 3);
    const notOut = enriched.filter((entry) => entry.live?.availability !== 'out');
    if (runtimeConfig.preferInStock && notOut.length) return notOut.slice(0, limit);
    return enriched.slice(0, limit);
  }

  async function rankProductsWithSafetyFallback(answers, maxResults) {
    const poolSize = Math.max(
      Number(maxResults) || 3,
      Number(runtimeConfig.availabilityCandidatePool) || 6,
      (Number(maxResults) || 3) * 3
    );

    const strictPool = rankProducts(answers, poolSize);
    if (strictPool.length) {
      const entries = await enrichRankingWithAvailability(strictPool, maxResults);
      return { entries, fallbackUsed: false, relaxed: [] };
    }

    // Defensive fallback for stale state or a changed catalogue. We only relax secondary preferences.
    const relaxedAnswers = Object.assign({}, answers, {
      form: 'any',
      stimulants: 'any'
    });
    const fallbackPool = rankProducts(relaxedAnswers, poolSize);
    const fallback = await enrichRankingWithAvailability(fallbackPool, maxResults);
    return {
      entries: fallback,
      fallbackUsed: fallback.length > 0,
      relaxed: fallback.length ? ['forma', 'kofeín'] : []
    };
  }
  ...
  function parseProductPage(html, product) {
    ...
    if (Number.isFinite(priceNumber) && priceNumber > 0) {
      try {
        price = new Intl.NumberFormat('sk-SK', { style: 'currency', currency, maximumFractionDigits: 0 }).format(priceNumber);
      } catch (_) {
  ...
  async function hydrateProduct(product) {
    ...
    const promise = (async () => {
      ...
      const timeoutMs = Math.max(500, Number(runtimeConfig.liveHydrationTimeoutMs) || 3500);
      const timeoutId = controller ? window.setTimeout(() => controller.abort(), timeoutMs) : null;

      try {
        const response = await fetch(fullUrl(product.url), {
  ...
  class ProductGuide {
        ...
        <section class="mbpg__shell mbpg__intro" aria-labelledby="${this.uid}-title">
          ...
          <div class="mbpg__body">
            <div class="mbpg__intro-head">
              <div>
                <span class="mbpg__eyebrow">MyBears sprievodca výberom</span>
                <h2 class="mbpg__title" id="${this.uid}-title">Pomôžeme vám vybrať vhodný produkt MyBears</h2>
                <p class="mbpg__lead">Každý hľadá niečo iné. Povedzte nám, na čo sa chcete zamerať a čo je pre vás pri výbere dôležité. Počas niekoľkých krátkych otázok vyberieme najvhodnejšie produkty z ponuky MyBears a vysvetlíme prečo.</p>
              </div>
              <div class="mbpg__mini"><strong>Rýchly sprievodca</strong>Pár krátkych otázok<br>Približne 1 minúta</div>
            </div>

            <div class="mbpg__steps" aria-label="Ako sprievodca funguje">
              <div class="mbpg__step-row"><span class="mbpg__icon mbpg__step-icon" style="${iconStyleVars('clipboard-check')}" aria-hidden="true">${iconSvg('clipboard-check')}</span><span class="mbpg__step-copy"><strong>Poviete nám, čo hľadáte</strong><span>Vyberiete hlavnú oblasť, na ktorú sa chcete zamerať.</span></span></div>
              <div class="mbpg__step-row"><span class="mbpg__icon mbpg__step-icon" style="${iconStyleVars('sliders')}" aria-hidden="true">${iconSvg('sliders')}</span><span class="mbpg__step-copy"><strong>Zohľadníme vaše preferencie</strong><span>Forma, vyhotovenie a ďalšie dôležité požiadavky spresnia výber.</span></span></div>
              <div class="mbpg__step-row"><span class="mbpg__icon mbpg__step-icon" style="${iconStyleVars('package-check')}" aria-hidden="true">${iconSvg('package-check')}</span><span class="mbpg__step-copy"><strong>Ukážeme vhodné produkty a prečo</strong><span>Uvidíte hlavné zložky, dávkovanie, cenu aj aktuálnu dostupnosť.</span></span></div>
            </div>

            <div class="mbpg__quality-strip" aria-label="Princípy MyBears">
              <span>Transparentné zloženie</span>
              <span>Zmysluplné dávky</span>
              <span>Pri vybraných produktoch laboratórne analýzy</span>
            </div>

            <div class="mbpg__actions"><button class="mbpg__button mbpg__button--primary" type="button" data-mbpg-action="start">Nájsť vhodný produkt</button></div>

            <div class="tldr-box"><p><strong>Vaše odpovede zostávajú iba v tomto sprievodcovi.</strong> Odporúčanie vychádza z parametrov produktov a vašich preferencií. Nevyhodnocuje zdravotný stav ani nenahrádza konzultáciu s lekárom alebo lekárnikom.</p></div>
          </div>
        </section>`;
    }
    ...
    featuredProductCard(entry) {
      ...
      const trustBadges = productTrustBadges(product);
      const specialBadges = productBadges(product)
        .filter((tag) => !['gumené medvedíky', 'kapsuly', 'softgely', 'prášok', 'kombinácia foriem', 'výhodný balíček', 'laboratórne overené'].includes(tag));
      const labLink = isLabTested(product)
        ? `<a class="mbpg__lab-link" href="${escapeHtml(fullUrl(runtimeConfig.labAnalysesUrl))}">Laboratórne analýzy</a>`
        : '';
      const imageMarkup = live?.image
        ? `<img src="${escapeHtml(fullUrl(live.image))}" alt="${escapeHtml(product.name)}" loading="lazy" decoding="async">`
      ...
      const addToCart = runtimeConfig.enableAddToCart
        ? (live?.availability === 'out'
          ? `<span class="mbpg__button mbpg__button--ghost" aria-disabled="true">Momentálne nedostupné</span>`
          : `<a class="mbpg__button mbpg__button--primary" href="${escapeHtml(buildCartUrl(product))}" data-mbpg-add="${escapeHtml(product.id)}">Do košíka</a>`)
        : '';
      ...
      return `
        <article class="mbpg__featured-product" data-mbpg-product-id="${escapeHtml(product.id)}" id="${this.uid}-product-${escapeHtml(product.id)}">
          <div class="mbpg__product-media" data-mbpg-media>${imageMarkup}</div>
          <div class="mbpg__product-copy">
            <span class="mbpg__match-label">Naše odporúčanie</span>
            ...
            <div class="mbpg__price-line" data-mbpg-price>${availabilityMarkup(live)}</div>
            ${trustBadges.length ? `<div class="mbpg__trust-badges">${trustBadges.map((tag) => `<span>${escapeHtml(tag)}</span>`).join('')}${labLink}</div>` : ''}
            <p class="mbpg__product-summary">${escapeHtml(product.summary)}</p>

            <div class="mbpg__why">
              <strong>Prečo zodpovedá vášmu výberu</strong>
            ...
            <table class="mbpg__facts-table">
              ...
              <tbody>
                ...
                <tr><th scope="row">Vyhotovenie</th><td>${escapeHtml(specialBadges.join(' · ') || 'bez osobitnej požiadavky')}</td></tr>
              </tbody>
            </table>
            ...
            <div class="mbpg__actions">
              <a class="mbpg__button mbpg__button--secondary" href="${escapeHtml(detailUrl)}" data-mbpg-product-link="${escapeHtml(product.id)}">Detail produktu</a>
              ${addToCart}
            </div>
          </div>
        </article>`;
    ...
    alternativeProductRow(entry, index) {
      ...
      return `
        <article class="mbpg__alternative" data-mbpg-product-id="${escapeHtml(product.id)}" id="${this.uid}-product-${escapeHtml(product.id)}">
          ...
          <span class="mbpg__price-line" data-mbpg-price>${availabilityMarkup(live, 'Overujeme…')}</span>
          <a class="mbpg__alternative-link" href="${escapeHtml(detailUrl)}" data-mbpg-product-link="${escapeHtml(product.id)}">Detail</a>
        </article>`;
    }
    ...
    comparisonTable(entries) {
      ...
      const rows = [
        ...
        ['Dávkovanie', (p) => p.dose],
        ['Vystačí', (p) => p.supply],
        ['Laboratórne overenie', (p) => isLabTested(p) ? 'áno – výsledky na webe' : 'bez zverejnenej analýzy v sprievodcovi'],
        ['Vyhotovenie', (p) => productBadges(p).filter((tag) => !['gumené medvedíky','kapsuly','softgely','prášok','kombinácia foriem','výhodný balíček'].includes(tag)).join(', ') || 'bez potvrdeného osobitného označenia'],
    ...
    async renderResults() {
      ...
      this.root.innerHTML = `
        <section class="mbpg__shell" aria-labelledby="${this.uid}-loading-title">
          <div class="mbpg__topline"></div>
          <div class="mbpg__body mbpg__loading-state">
            <span class="mbpg__icon mbpg__loading-icon" style="${iconStyleVars('package-check')}" aria-hidden="true">${iconSvg('package-check')}</span>
            <h2 class="mbpg__title" id="${this.uid}-loading-title">Vyhodnocujeme vaše odpovede</h2>
            <p class="mbpg__lead">Porovnávame vhodnosť produktov a overujeme ich aktuálnu cenu a dostupnosť.</p>
          </div>
        </section>`;

      const ranking = await rankProductsWithSafetyFallback(this.answers, runtimeConfig.maxResults);
      if (requestId !== this.resultRequestId || !this.root.isConnected) return;
        ...
        this.root.innerHTML = `
          <section class="mbpg__shell" aria-labelledby="${this.uid}-no-result">
            ...
            <div class="mbpg__body mbpg__empty">
              <h2 class="mbpg__title" id="${this.uid}-no-result">Pre túto kombináciu nemáme vhodné automatické odporúčanie</h2>
              <p class="mbpg__lead">Skúste upraviť niektorú z preferencií alebo si prezrite celú ponuku. Sprievodca zámerne neukazuje produkt za každú cenu, ak výber nedáva dostatočný zmysel.</p>
      ...
      const fallbackMessage = ranking.fallbackUsed
        ? `<div class="mbpg__notice"><span class="mbpg__notice-icon" aria-hidden="true">${iconSvg('info')}</span><div><strong>Uvoľnili sme vedľajšie preferencie.</strong> Pre zachovanie zmysluplného odporúčania sme nezohľadnili: ${escapeHtml(ranking.relaxed.join(', '))}. Hlavná oblasť a cieľová skupina zostali zachované.</div></div>`
        : '';
      const overlapLink = runtimeConfig.overlapCheckerUrl
        ? `<a class="mbpg__button mbpg__button--secondary" href="${escapeHtml(fullUrl(runtimeConfig.overlapCheckerUrl))}">Skontrolovať prekrytie účinných látok</a>`
        : '';
        ...
        <section class="mbpg__shell" aria-labelledby="${this.uid}-results-title">
          ...
          <div class="mbpg__body">
            <div class="mbpg__results-head">
              <span class="mbpg__eyebrow">Výsledok sprievodcu</span>
              <h2 class="mbpg__title" id="${this.uid}-results-title" tabindex="-1">Najlepšie zodpovedá vášmu výberu</h2>
              <p class="mbpg__lead">Odporúčanie vychádza z vybranej oblasti, formy a vašich požiadaviek. Pri poradí zohľadňujeme aj aktuálnu dostupnosť produktu.</p>
            </div>

            <div class="mbpg__result-summary"><span class="mbpg__notice-icon" aria-hidden="true">${iconSvg('check')}</span><div><strong>Vaše preferencie</strong>${escapeHtml(answerSummary.join(' · '))}</div></div>

            ${this.featuredProductCard(featured)}

            ${alternatives.length ? `
              <h3 class="mbpg__alternative-title">Ďalšie vhodné možnosti</h3>
            ...
            <div class="mbpg__next-tools">
              <div><strong>Už užívate ďalšie doplnky?</strong><span>Overte si, či sa vám zbytočne neprekrývajú rovnaké účinné látky.</span></div>
              ${overlapLink}
            </div>

            <div class="tldr-box"><p><strong>Dôležité upozornenie:</strong> Sprievodca posudzuje parametre produktov a zvolené preferencie. Nevyhodnocuje diagnózy, liečbu, tehotenstvo ani individuálnu potrebu konkrétnych látok. Preto napríklad automaticky neodporúča doplnok so železom iba na základe všeobecnej voľby „energia“. Pred použitím vždy skontrolujte aktuálnu etiketu a upozornenia na detaile produktu.</p></div>
...
function normalizePlacementText(value) {
  ...
  function smallestCommonAncestor(nodes) {
    const anchors = (nodes || []).filter(Boolean);
  ...
  function findBenefitGroup(scope = document) {
    ...
    const elements = Array.from(root.querySelectorAll(
      'a, h1, h2, h3, h4, h5, strong, p, span, div, li, section, article'
    ));

    const textOf = (element) => normalizePlacementText(element?.textContent || '');

    function findMatches(needles) {
      const normalizedNeedles = needles.map(normalizePlacementText);
      return elements
        .filter((element) => {
    ...
    function isPlausibleBenefitContainer(node) {
      if (!node || node === document.body || node === document.documentElement) return false;
      const text = textOf(node);
      if (!text || text.length > 2400) return false;

      // A real benefits strip must not swallow the product grid. This prevents
      // a duplicate "MyBears klub" in the footer from promoting the common
      // ancestor to the whole page/main content.
      if (uniqueProductLinks(node).length >= 2) return false;
      return true;
    }

    const quality = findMatches([
      'kvalitné suroviny',
      'kvalitne suroviny',
      'kvalita bez kompromisov',
      'kvalita a transparentné zloženie',
      'bio & vegan & halal & gmp'
    ]);

    const transparency = findMatches([
      'transparentné zloženie',
      'transparentne zlozenie',
      'transparentné účinné dávky',
      'transparentne uvádzame zloženie',
      'kvalita a transparentné zloženie'
    ]);

    const laboratory = findMatches([
      'laboratórne overujeme',
      'laboratorne overujeme',
      'laboratórne testované',
      'laboratorne testovane'
    ]);

    const club = findMatches(['mybears klub']);

    // Current 2026 homepage: 4 pillars. Try several candidates for MyBears klub,
    // because the same wording also exists lower on the page and in the footer.
    const primary = [quality[0], transparency[0], laboratory[0]].filter(Boolean);
    if (primary.length >= 3) {
      for (const clubAnchor of club.slice(0, 8)) {
        const candidate = smallestCommonAncestor([...primary, clubAnchor]);
        if (isPlausibleBenefitContainer(candidate)) return candidate;
      }

      // Still support a temporary 3-card state while homepage content is being
      // published or asynchronously hydrated.
      const candidate = smallestCommonAncestor(primary);
      if (isPlausibleBenefitContainer(candidate)) return candidate;
    }

    // Legacy SK homepage fallback: quality + laboratory or combined
    // quality/transparency card. Require at least two independent anchors.
    const legacyAnchors = [quality[0], transparency[0], laboratory[0]].filter(Boolean);
    if (legacyAnchors.length >= 2) {
      const candidate = smallestCommonAncestor(legacyAnchors);
      if (isPlausibleBenefitContainer(candidate)) return candidate;
    }
  ...
  function findProductTabsGroup(scope = document) {
    const root = scope?.querySelectorAll ? scope : document;
    const elements = Array.from(root.querySelectorAll(
      'a, button, h2, h3, h4, strong, span, div, li, nav, section'
    ));
    const textOf = (element) => normalizePlacementText(element?.textContent || '');

    function smallestMatch(needle) {
      const target = normalizePlacementText(needle);
      return elements
        .filter((element) => textOf(element).includes(target))
        .sort((a, b) => textOf(a).length - textOf(b).length)[0] || null;
    }

    const superPrice = smallestMatch('super cena');
    const bestsellers = smallestMatch('najpredávanejšie') || smallestMatch('najpredavanejsie');
    if (!superPrice || !bestsellers) return null;

    const candidate = smallestCommonAncestor([superPrice, bestsellers]);
  ...
  function createHomepageRoot() {
    ...
    // Exact visual fallback for the homepage layout: the guide belongs directly
    // above the product tabs ("Super cena" / "Najpredávanejšie"). This is more
    // deterministic than appending to <main> if the benefit cards are temporarily
    // unavailable while Upgates hydrates the page.
    const productTabs = findProductTabsGroup(document);
    if (productTabs?.parentNode) {
      productTabs.parentNode.insertBefore(root, productTabs);
      return root;
    }
  ...
  function boot(scope) {
    ...
    // Upgates can render / replace homepage modules after DOMContentLoaded.
    // Therefore homepage auto-mount must not depend on boot() being called
    // only with document/body. If the guide is still missing, retry the
    // homepage placement whenever boot is invoked for newly inserted content.
    if (isConfiguredHomepage() && !document.querySelector(ROOT_SELECTOR)) {
      createHomepageRoot();
    }
    ...
    // The root may have been created outside of the newly added subtree.
    // Always include the document-level root as a defensive fallback.
    const documentRoot = document.querySelector(ROOT_SELECTOR);
  ...
  window.MyBearsProductGuide = Object.freeze({
    ...
    guideUpdatedAt: GUIDE_UPDATED_AT,
    catalog: CATALOG,
    questions: QUESTIONS,
    boot,
  ...
  let homepageRetryTimer = null;

  function retryHomepageMount(delay) {
    if (!isConfiguredHomepage()) return;
    window.clearTimeout(homepageRetryTimer);
    homepageRetryTimer = window.setTimeout(() => {
      boot(document);
  ...
  function initialBoot() {
    boot(document);
    // Defensive retries for Upgates modules that are hydrated shortly after
    // DOMContentLoaded. Calls are idempotent because createHomepageRoot() and
    // mount() both refuse duplicate instances.
    window.setTimeout(() => boot(document), 250);
    window.setTimeout(() => boot(document), 1000);
    window.setTimeout(() => boot(document), 2500);
  }
  ...
  const observer = new MutationObserver((mutations) => {
    let hasElementAddition = false;
    mutations.forEach((mutation) => mutation.addedNodes.forEach((node) => {
      if (node.nodeType === 1) {
        hasElementAddition = true;
        boot(node);
      }
    }));

    // Debounced document-level retry ensures that a benefit row / product grid
    // rendered asynchronously can still become the placement anchor.
    if (hasElementAddition && !document.querySelector(ROOT_SELECTOR)) {
      retryHomepageMount(80);
    }
  });
