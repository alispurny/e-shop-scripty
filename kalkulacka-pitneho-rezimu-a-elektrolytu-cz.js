...
`;
  ...
  function init() {
    ...
    root.innerHTML = [
      ...
      '    <h2 class="mb-hy__title" id="mb-hy-title">Kalkulačka pitného režimu a ztrát potem</h2>',
      '    <p class="mb-hy__lead">Spočítejte orientační denní rozmezí tekutin nebo proveďte vlastní test pocení a odhadněte ztrátu sodíku.</p>',
      '  </div>',
      '  <div class="mb-hy__body">',
      '    <p class="mb-hy__notice"><strong>Důležité:</strong> Potřeba tekutin i koncentrace sodíku v potu jsou individuální. Výsledky nejsou doporučením k automatickému doplnění stejného množství vody nebo elektrolytů.</p>',
      '    <div class="mb-hy__tabs" role="tablist" aria-label="Režim kalkulačky">',
      '      <button type="button" class="mb-hy__tab" id="mb-hy-tab-daily" role="tab" aria-controls="mb-hy-panel-daily" aria-selected="true">Denní pitný režim</button>',
      '      <button type="button" class="mb-hy__tab" id="mb-hy-tab-sweat" role="tab" aria-controls="mb-hy-panel-sweat" aria-selected="false">Test pocení a sodíku</button>',
      '    </div>',
      ...
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-weight">Hmotnost</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-weight" inputmode="decimal" autocomplete="off" value="70" aria-describedby="mb-hy-weight-hint"><span class="mb-hy__unit">kg</span></div><span class="mb-hy__hint" id="mb-hy-weight-hint">Povolené rozmezí: 30–250 kg</span></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-age">Věk</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-age" inputmode="numeric" autocomplete="off" value="35"><span class="mb-hy__unit">let</span></div><span class="mb-hy__hint">Kalkulačka je určena dospělým od 18 let.</span></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-sex">Referenční skupina</label><select class="mb-hy__select" id="mb-hy-sex"><option value="female">Žena</option><option value="male">Muž</option></select><span class="mb-hy__hint">Používá se pouze pro srovnání s referenčním příjmem celkové vody EFSA.</span></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-glass">Velikost sklenice</label><select class="mb-hy__select" id="mb-hy-glass"><option value="200">200 ml</option><option value="250" selected>250 ml</option><option value="300">300 ml</option></select><span class="mb-hy__hint">Přepočet je pouze pro snazší představu.</span></div>',
      '        </div>',
      '        <div class="mb-hy__actions"><button class="mb-hy__button mb-hy__button--primary" type="submit">Vypočítat pitný režim</button><button class="mb-hy__button mb-hy__button--secondary" type="button" id="mb-hy-daily-reset">Vymazat údaje</button></div>',
      ...
      '        <div class="mb-hy__grid">',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-pre">Hmotnost před aktivitou</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-pre" inputmode="decimal" autocomplete="off" value="75"><span class="mb-hy__unit">kg</span></div></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-post">Hmotnost po aktivitě</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-post" inputmode="decimal" autocomplete="off" value="74,4"><span class="mb-hy__unit">kg</span></div></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-duration">Délka aktivity</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-duration" inputmode="numeric" autocomplete="off" value="60"><span class="mb-hy__unit">min</span></div></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-drink">Tekutiny vypité během aktivity</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-drink" inputmode="decimal" autocomplete="off" value="500"><span class="mb-hy__unit">ml</span></div></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-urine">Moč během aktivity</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-urine" inputmode="decimal" autocomplete="off" value="0"><span class="mb-hy__unit">ml</span></div><span class="mb-hy__hint">Pokud jste během testu nemočili, ponechte 0.</span></div>',
      '          <div class="mb-hy__field"><label class="mb-hy__label" for="mb-hy-sodium-mode">Koncentrace sodíku v potu</label><select class="mb-hy__select" id="mb-hy-sodium-mode"><option value="unknown">Nevím – zobrazit široké rozpětí</option><option value="mg">Znám hodnotu v mg/l</option><option value="mmol">Znám hodnotu v mmol/l</option></select><span class="mb-hy__hint">Přesnější hodnotu poskytne validované vyšetření potu.</span></div>',
      '          <div class="mb-hy__field mb-hy__custom" id="mb-hy-sodium-custom" hidden><label class="mb-hy__label" for="mb-hy-sodium-value">Zadejte koncentraci sodíku</label><div class="mb-hy__input-wrap"><input class="mb-hy__input" id="mb-hy-sodium-value" inputmode="decimal" autocomplete="off" value="900"><span class="mb-hy__unit" id="mb-hy-sodium-unit">mg/l</span></div></div>',
      '        </div>',
      '        <div class="mb-hy__actions"><button class="mb-hy__button mb-hy__button--primary" type="submit">Vypočítat ztrátu potem</button><button class="mb-hy__button mb-hy__button--secondary" type="button" id="mb-hy-sweat-reset">Vymazat údaje</button></div>',
      ...
      '    </div>',
      '    <p class="mb-hy__privacy">Výpočty probíhají pouze ve vašem prohlížeči. Zadané údaje se tímto skriptem nikam neodesílají ani neukládají.</p>',
      '  </div>',
      '</section>'
    ].join('');
    ...
    dailyForm.addEventListener('submit', function (event) {
      ...
      if (!Number.isFinite(weight) || weight < 30 || weight > 250) return showError(dailyError, 'Zadejte hmotnost v rozmezí 30–250 kg.');
      if (!Number.isFinite(age) || age < 18 || age > 100) return showError(dailyError, 'Zadejte věk v rozmezí 18–100 let.');
      ...
      if (weight >= 120) {
        warning = '<div class="mb-hy__warning"><strong>Pozor:</strong> Výpočet podle aktuální hmotnosti může u vyšší tělesné hmotnosti poskytovat vysoké hodnoty. Výsledek proto berte jako široké pracovní rozmezí, nikoliv jako povinný cíl.</div>';
      }

      dailyResult.innerHTML = [
        '<div class="mb-hy__result-top"><div><p class="mb-hy__result-label">Orientační denní rozmezí tekutin</p><p class="mb-hy__score">' + formatNumber(lowMl / 1000, 1) + '–' + formatNumber(highMl / 1000, 1) + ' l</p></div><span class="mb-hy__badge">' + lowMlKg + '–' + highMlKg + ' ml/kg</span></div>',
        '<p class="mb-hy__summary">Jde o orientační pracovní rozmezí pro běžný den. Potřeba se může zvýšit při horku, delší fyzické aktivitě, horečce, průjmu nebo zvracení. Část vody přijímáte také z potravin.</p>',
        '<div class="mb-hy__metrics">',
        '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Přepočet na sklenice</p><p class="mb-hy__metric-value">' + formatNumber(lowGlasses, 0) + '–' + formatNumber(highGlasses, 0) + ' × ' + glass + ' ml</p></div>',
        '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Referenční celková voda EFSA</p><p class="mb-hy__metric-value">' + formatNumber(efsaMl / 1000, 1) + ' l/den</p></div>',
        '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Při sportu a horku</p><p class="mb-hy__metric-value">Použijte test pocení</p></div>',
        '</div>',
        '<div class="mb-hy__warning"><strong>Referenční hodnota EFSA zahrnuje vodu z nápojů i potravin.</strong> Nelze ji chápat jako povinné množství čisté vody. Při onemocnění srdce nebo ledvin a při omezení tekutin se řiďte pokyny lékaře.</div>',
        warning
      ].join('');
    ...
    sweatForm.addEventListener('submit', function (event) {
      ...
      if (!Number.isFinite(pre) || pre < 30 || pre > 250) return showError(sweatError, 'Zadejte hmotnost před aktivitou v rozmezí 30–250 kg.');
      if (!Number.isFinite(post) || post < 30 || post > 250) return showError(sweatError, 'Zadejte hmotnost po aktivitě v rozmezí 30–250 kg.');
      if (!Number.isFinite(duration) || duration < 15 || duration > 720) return showError(sweatError, 'Zadejte délku aktivity v rozmezí 15–720 minut.');
      if (!Number.isFinite(drinkMl) || drinkMl < 0 || drinkMl > 10000) return showError(sweatError, 'Zadejte množství vypitých tekutin od 0 do 10 000 ml.');
      if (!Number.isFinite(urineMl) || urineMl < 0 || urineMl > 5000) return showError(sweatError, 'Zadejte množství moči od 0 do 5 000 ml.');
      if (mode !== 'unknown' && (!Number.isFinite(sodiumValue) || sodiumValue <= 0)) return showError(sweatError, 'Zadejte platnou koncentraci sodíku v potu.');

      var hours = duration / 60;
      var bodyMassChangeKg = pre - post;
      var sweatLossL = bodyMassChangeKg + (drinkMl / 1000) - (urineMl / 1000);
      if (sweatLossL <= 0) return showError(sweatError, 'Zadané hodnoty vedou k nulové nebo záporné ztrátě potem. Zkontrolujte hmotnost, vypité tekutiny a moč.');

      var sweatRate = sweatLossL / hours;
      var massChangePct = ((post - pre) / pre) * 100;
      var rateLabel = sweatRate < 0.5 ? 'nižší pocení' : sweatRate < 1.0 ? 'střední pocení' : sweatRate < 1.5 ? 'vyšší pocení' : 'velmi vysoké pocení';
      var sodiumHtml = '';

      if (mode === 'unknown') {
        var sodiumLowMg = sweatLossL * 20 * 22.99;
        var sodiumHighMg = sweatLossL * 80 * 22.99;
        sodiumHtml = '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Modelová ztráta sodíku</p><p class="mb-hy__metric-value">' + formatNumber(sodiumLowMg, 0) + '–' + formatNumber(sodiumHighMg, 0) + ' mg</p></div>';
      } else {
        var sodiumMgL = mode === 'mmol' ? sodiumValue * 22.99 : sodiumValue;
        var sodiumLossMg = sweatLossL * sodiumMgL;
        sodiumHtml = '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Odhad ztráty sodíku</p><p class="mb-hy__metric-value">' + formatNumber(sodiumLossMg, 0) + ' mg</p></div>';
      }

      var overdrinkWarning = '';
      if (massChangePct > 0.2) {
        overdrinkWarning = '<div class="mb-hy__warning"><strong>Hmotnost po aktivitě je vyšší než před ní.</strong> To může znamenat, že příjem tekutin převýšil čistou ztrátu. Během delší aktivity není vhodné pít tak, aby hmotnost rostla.</div>';
      } else if (massChangePct <= -2) {
        overdrinkWarning = '<div class="mb-hy__warning"><strong>Pokles hmotnosti dosáhl přibližně 2 % nebo více.</strong> Výsledek je vhodné zohlednit při plánování pití pro podobnou aktivitu a stejné podmínky.</div>';
      }

      sweatResult.innerHTML = [
        '<div class="mb-hy__result-top"><div><p class="mb-hy__result-label">Odhadovaná ztráta potem</p><p class="mb-hy__score">' + formatNumber(sweatLossL, 2) + ' l</p></div><span class="mb-hy__badge">' + rateLabel + '</span></div>',
        '<p class="mb-hy__summary">Výpočet vychází ze změny hmotnosti upravené o vypité tekutiny a případnou moč. Opakujte test ve stejném sportu a podobné teplotě, protože rychlost pocení se mezi podmínkami výrazně mění.</p>',
        '<div class="mb-hy__metrics">',
        '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Rychlost pocení</p><p class="mb-hy__metric-value">' + formatNumber(sweatRate, 2) + ' l/h</p></div>',
        '<div class="mb-hy__metric"><p class="mb-hy__metric-label">Změna tělesné hmotnosti</p><p class="mb-hy__metric-value">' + formatNumber(massChangePct, 1) + ' %</p></div>',
        sodiumHtml,
        '</div>',
        '<div class="mb-hy__warning"><strong>Ztráta sodíku není automatická dávka k doplnění.</strong> Potřeba sodíku závisí také na délce aktivity, množství vypitých tekutin, jídle a zdravotním stavu. Draslík, hořčík a vápník kalkulačka přesně nepočítá, protože je nelze spolehlivě odvodit jen z hmotnosti a délky aktivity.</div>',
        overdrinkWarning
      ].join('');
