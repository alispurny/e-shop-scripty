...
(function () {
  ...
  var T = {"locale":"sk-SK","version":"5.0.0-sk","title":"BMI kalkulačka pre dospelých","lead":"Zadajte svoju výšku a hmotnosť. Kalkulačka vypočíta BMI, orientačnú kategóriu a hmotnostné rozmedzie zodpovedajúce BMI 18,5–24,9.","notice":"<strong>Dôležité:</strong> Kalkulačka je určená pre dospelých od 18 rokov. Nie je určená pre deti, dospievajúcich ani na hodnotenie hmotnosti v tehotenstve.","height":"Výška","height_ph":"napr. 172","height_hint":"Povolené rozmedzie: 100–250 cm","weight":"Hmotnosť","weight_ph":"napr. 74,5","weight_hint":"Povolené rozmedzie: 20–400 kg","calculate":"Vypočítať BMI","reset":"Vymazať údaje","result_label":"Vaše orientačné BMI","scale_title":"Orientačné zaradenie výsledku","underweight_scale":"Podváha<br>&lt; 18,5","healthy_scale":"Bežné<br>18,5–24,9","overweight_scale":"Nadváha<br>25–29,9","obesity_scale":"Obezita<br>30 a viac","range_label":"Orientačné hmotnostné rozmedzie","inputs_label":"Zadané údaje","note":"<strong>Výsledok je orientačný.</strong> BMI nerozlišuje tukovú, svalovú a kostnú hmotu a samo osebe neurčuje zdravotný stav. Pri nechcenom úbytku či náraste hmotnosti alebo zdravotných ťažkostiach sa obráťte na lekára.","privacy":"Výpočet prebieha iba vo vašom prehliadači. Zadaná výška ani hmotnosť sa týmto skriptom nikam neodosielajú ani neukladajú.","region_label":"Interaktívna BMI kalkulačka pre dospelých","formula":"Výpočet: {{weight}} kg ÷ ({{height}} m × {{height}} m) = BMI {{bmi}}.","errors":{"number":"Vyplňte, prosím, výšku aj hmotnosť ako číslo. Môžete použiť desatinnú čiarku alebo bodku.","height":"Skontrolujte zadanú výšku. Kalkulačka prijíma hodnoty od 100 do 250 cm.","weight":"Skontrolujte zadanú hmotnosť. Kalkulačka prijíma hodnoty od 20 do 400 kg."},"categories":[{"max":18.5,"label":"Podváha","key":"underweight","summary":"Výsledok patrí do pásma podváhy. BMI samo neukazuje príčinu nižšej hmotnosti ani stav výživy."},{"max":25,"label":"Bežné rozmedzie","key":"healthy","summary":"Výsledok patrí do bežného referenčného rozmedzia BMI pre dospelých. Celkový zdravotný stav však nemožno posúdiť iba podľa BMI."},{"max":30,"label":"Nadváha","key":"overweight","summary":"Výsledok patrí do pásma nadváhy. Na presnejšie posúdenie má význam zohľadniť aj obvod pása, telesné zloženie a ďalšie zdravotné ukazovatele."},{"max":35,"label":"Obezita I. stupňa","key":"obesity-1","summary":"Výsledok patrí do pásma obezity I. stupňa. BMI je orientačný skríningový údaj, nie samostatná diagnóza."},{"max":40,"label":"Obezita II. stupňa","key":"obesity-2","summary":"Výsledok patrí do pásma obezity II. stupňa. Individuálny význam je vhodné posúdiť spolu s lekárom a ďalšími zdravotnými ukazovateľmi."},{"max":null,"label":"Obezita III. stupňa","key":"obesity-3","summary":"Výsledok patrí do pásma obezity III. stupňa. Na bezpečné posúdenie zdravotného stavu a ďalšieho postupu je vhodná konzultácia s lekárom."}]};
