...
@media (max-width:650px){.mbia{margin:14px 0}.mbia__topic-row{flex-wrap:nowrap;overflow-x:auto;scrollbar-width:thin}.mbia__shell{border-radius:10px}.mbia__hero{padding:22px 18px}.mbia__title{font-size:25px}.mbia__lead{font-size:15px}.mbia__body{padding:18px}.mbia__search-panel{grid-template-columns:1fr;padding:12px}.mbia__series-grid,.mbia__featured,.mbia__grid,.mbia-related__grid{grid-template-columns:1fr}.mbia__toolbar{align-items:flex-start}.mbia__card-actions{flex-direction:column}.mbia__btn{width:100%}.mbia-toc{padding:15px}}
...
`;
  ...
  function createHub(root) {
    ...
    root.innerHTML = '<div class="mbia__shell"><header class="mbia__hero"><h2 class="mbia__title">Najděte článek podle toho, co právě řešíte</h2><div class="mbia__hero-meta"><span class="mbia__hero-chip">Aktuální články z poradny</span><span class="mbia__hero-chip">Tematické série</span><span class="mbia__hero-chip">Bez registrace</span></div></header><div class="mbia__body" data-role="body"><div class="mbia__skeleton" aria-label="Načítání článků"></div></div></div>';
    ...
    function renderControls() {
      ...
      }).join('') + '</div></section>' + seriesHtml() + '<div data-role="results"></div><div class="mbia__note">Interaktivní přehled načítá články z hlavního blogu MyBears. Informace v článcích mají vzdělávací charakter a nenahrazují individuální vyšetření ani doporučení lékaře.</div>';
      bindControls();
      renderResults();
    }
