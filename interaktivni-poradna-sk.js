...
`;
  ...
  const FALLBACK_ARTICLES = [
    ...
    {
      title: 'Prediabetes: hodnoty cukru v krvi, príznaky a čo možno zmeniť',
    ...
    {
      title: 'Metabolický syndróm: ako spolu súvisia obvod pása, tlak, cukor a triglyceridy',
      url: '/advisor/metabolicky-syndrom-priznaky-kriteria-lecba',
      description: 'Päť kritérií metabolického syndromu, ich vzájomné súvislosti a praktický plán zmien.'
    },
    {
      title: 'Výživa kĺbov: ktoré zložky fungujú a prečo ich kombinovať',
    ...
    {
      title: 'Pitný režim: koľko piť a ako rozpoznať dehydratáciu',
    ...
    {
      title: 'Kortizol a spánok: prečo sa v noci budíte a ráno ste unavení',
