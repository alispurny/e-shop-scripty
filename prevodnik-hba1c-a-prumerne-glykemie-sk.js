      ...
      '<section class="mb-a1c" aria-labelledby="mb-a1c-title">' +
        ...
        '<div class="mb-a1c__body">' +
          ...
          '<div class="mb-a1c__tabs" role="tablist" aria-label="' + T.tabs_label + '">' +
            '<button class="mb-a1c__tab" type="button" role="tab" id="mb-a1c-tab-hba1c" aria-controls="mb-a1c-panel-hba1c" aria-selected="true" data-tab="hba1c">' + T.tab_hba1c + '</button>' +
            '<button class="mb-a1c__tab" type="button" role="tab" id="mb-a1c-tab-glucose" aria-controls="mb-a1c-panel-glucose" aria-selected="false" data-tab="glucose">' + T.tab_glucose + '</button>' +
          '</div>' +
